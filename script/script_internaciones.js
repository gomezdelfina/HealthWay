...
function OpcionPaciente() {
    ...
    fetch("/HTML/Healthway/api/internaciones/InternacionPaciente.php")
...
function OpcionSolicitud() {
    ...
    function cargarSolicitudes() {
        ...
        fetch(`/HTML/Healthway/api/internaciones/InternacionSolicitud.php?idPaciente=${idPaciente}`)
            .then(r => r.json())
            .then(data => {
                data.forEach(item => {
                    const option = document.createElement('option');
...
function OpcionHabitacion() {
    ...
    selectHabitacion.addEventListener('change', function() {
        ...
        fetch(`/HTML/Healthway/api/internaciones/InternacionHabitacion.php?tipoHab=${valor}`)
            .then(response => response.json())
            .then(data => {
...
function OpcionCama() {
    ...
    function cargarCamas(origen) {
        ...
        fetch(`/HTML/Healthway/api/internaciones/InternacionCama.php?numeroHab=${encodeURIComponent(numeroHab)}`)
            .then(r => r.json())
            .then(data => {
                selectCama.innerHTML = '<option value="">Seleccione una cama</option>';
...
async function validarForm() {
    ...
    const respuesta = await fetch("/HTML/Healthway/api/internaciones/RegistrarInternaciones.php", {
        method: "POST",
        body: datos
    });
