<?php
    ...
    if (!isset($_SESSION['usuario'])) {
    ...
    } elseif(!Permisos::tienePermiso(13, $_SESSION['usuario'])){
        $response['code'] = 401;
        ...
        if (empty($data)) {
            ...
            if (!isset($data['IdPaciente'])) {
                ...
                if ($idPaciente == '') {
                    ...
                    $inter = internaciones::VerInternacionActivaByPac($idPaciente);
        ...
        // OBSERVACIONES
            ...
            if($dtInicio < $dtCreacion){
                $errors['FechaInicio'] = 'El campo FechaInicio debe ser anterior al dia de la fecha';
            } elseif (!empty($dtFin)){
                if ($dtFin < $dtInicio){
                    $errors['FechaFin'] = 'El campo FechaFin debe ser anterior al dia de inicio';
                }
            }
